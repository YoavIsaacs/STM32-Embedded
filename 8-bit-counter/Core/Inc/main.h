...
#define ONE_Pin GPIO_PIN_1
#define ONE_GPIO_Port GPIOA
#define SEVEN_Pin GPIO_PIN_2
#define SEVEN_GPIO_Port GPIOA
#define TWO_Pin GPIO_PIN_3
#define TWO_GPIO_Port GPIOA
#define THREE_Pin GPIO_PIN_4
#define THREE_GPIO_Port GPIOA
#define FOUR_Pin GPIO_PIN_5
#define FOUR_GPIO_Port GPIOA
#define FIVE_Pin GPIO_PIN_6
#define FIVE_GPIO_Port GPIOA
#define SIX_Pin GPIO_PIN_7

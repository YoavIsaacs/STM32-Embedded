...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, ZERO_Pin|ONE_Pin|SEVEN_Pin|TWO_Pin
                          |THREE_Pin|FOUR_Pin|FIVE_Pin|SIX_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ZERO_Pin ONE_Pin SEVEN_Pin TWO_Pin
                           THREE_Pin FOUR_Pin FIVE_Pin SIX_Pin */
  GPIO_InitStruct.Pin = ZERO_Pin|ONE_Pin|SEVEN_Pin|TWO_Pin
                          |THREE_Pin|FOUR_Pin|FIVE_Pin|SIX_Pin;
